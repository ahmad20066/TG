    ...
    const services = [
        {
            icon: "🎯",
            title: "Production",
            description: "High-quality production services with modern techniques and creative excellence.",
            items: ["Photo & Video", "Motion Graphics", "CGI / 3D", "Props & Sets"],
        },
        {
            icon: "💡",
            title: "Marketing & Communication",
            description: "Strategic solutions to amplify your brand and drive meaningful engagement.",
            items: ["Strategy", "Content Creation", "Social Media", "Branding"],
        },
        {
            icon: "⚡",
            title: "Tech",
            description: "Innovative digital solutions that transform ideas into powerful platforms.",
            items: ["Applications", "Websites", "E-Commerce", "UI/UX"],
        }
    ];
                    ...
                    {services.map((service, index) => (
                        ...
                        >
                            <div className="service-card-content">
                                ...
                                <motion.button
                                    className={`service-cta ${index === 1 ? 'service-cta-white' : ''}`}
                                    whileHover={{
                                        scale: 1.05,
                                        transition: { duration: 0.2 }
                                    }}
